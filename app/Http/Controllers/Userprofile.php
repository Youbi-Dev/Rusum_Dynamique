...
class Userprofile extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $contact_info->Adresse          =$request->Adresse;
        ...
        return redirect()->route('index')->withSuccess("Profil utilisateur créé avec succès");
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->back()->withSuccess("Profil utilisateur mis à jour avec succès");
    }
    ...
    public function destroy($id)
    {
        ...
        if (!empty($id)) {
            ...
            return redirect()->back()->withSuccess("Profil utilisateur supprimé avec succès");
        } else {

            return redirect()->back()->withSuccess("Quelque chose s'est mal passé");
        }
    }
}
